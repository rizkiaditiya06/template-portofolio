        ...
        <section className="pricing container section">
            ...
            <div className="pricing__container grid">
                <div className="pricing__item">
                    ...
                    <p className="pricing__title">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo, sed!</p>
                    <p className="pricing__support">Email support</p>
                    <h3 className="price">
                        <em>Rp.</em> 9 <span>Month</span>
                    </h3>
                ...
                <div className="pricing__item best">
                    ...
                    <p className="pricing__title">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam, quidem.</p>
                    <p className="pricing__support">Mon-Fri support</p>
                    <h3 className="price">
                        <em>Rp.</em> 15 <span>Month</span>
                    </h3>
                    <a href="" className="btn">Get Started</a>
                </div>
                ...
                <div className="pricing__item">
                    ...
                    <p className="pricing__title">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, incidunt.</p>
                    <p className="pricing__support">24 /7 support</p>
                    <h3 className="price">
                        <em>Rp.</em> 19 <span>Month</span>
                    </h3>
                    <a href="" className="btn">Get Started</a>
                </div>
            </div>
